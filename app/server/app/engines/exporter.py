...
from app.engines.real_exporter import RealExporter
...
class ExporterEngine:
    ...
    def __init__(self):
        ...
        self.real_exporter = RealExporter() if not settings.SAFE_MODE else None
    ...
    async def _generate_pdf(self, data: Dict[str, Any], quest_id: str) -> str:
        ...
        if self.real_exporter:
            try:
                return await self.real_exporter.generate_pdf(data, quest_id)
            except Exception as e:
                logger.error("Real PDF generation failed, using mock", error=str(e))
    ...
    async def _generate_ics(self, data: Dict[str, Any], quest_id: str) -> str:
        ...
        if self.real_exporter:
            try:
                return await self.real_exporter.generate_ics(data, quest_id)
            except Exception as e:
                logger.error("Real ICS generation failed, using mock", error=str(e))
        
        # Fallback to mock ICS generation
    ...
    async def _generate_markdown(self, data: Dict[str, Any], quest_id: str) -> str:
        ...
        if self.real_exporter:
            try:
                return await self.real_exporter.generate_markdown(data, quest_id)
            except Exception as e:
                logger.error("Real Markdown generation failed, using mock", error=str(e))
        
        # Fallback to mock markdown generation
    ...
    async def _generate_csv(self, data: Dict[str, Any], quest_id: str) -> str:
        ...
        if self.real_exporter:
            try:
                return await self.real_exporter.generate_csv(data, quest_id)
            except Exception as e:
                logger.error("Real CSV generation failed, using mock", error=str(e))
        
        # Fallback to mock CSV generation
